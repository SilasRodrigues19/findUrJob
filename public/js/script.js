...
const validateFields =
    () => {
      if (job_title.value == "" || job_link.value == "" ||
          job_level.value == "" || job_currency.value == "" ||
          job_salary.value == "" || job_mode.value == "" ||
          job_contract.value == "") {
...
const splitRequirements =
    () => {
      let splited_job_requirements =
              document.querySelector('#splited_job_requirements'),
