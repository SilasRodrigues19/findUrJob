			...
			<footer class="footer">
					...
					<div class="content has-text-centered">
						<p>
							© <?= date('Y') ?> Todos os direitos reservados. Desenvolvido por <a href="https://silasrodrigues.vercel.app/" rel="noopener" aria-label="Acessar o Portfolio de Silas Rodrigues">Silas Rodrigues</a>.
						</p>
					</div>
